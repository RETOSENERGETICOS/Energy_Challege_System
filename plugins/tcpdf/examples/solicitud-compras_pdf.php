...
class imprimirFactura
{
    ...
    <tr>
        ...
        <td height="100"  class="left-section">
            ...
            <p style="text-align:center; font-size:10px; color:#1B4F72; line-height:-.1;">-</p>
            <p style="text-align:center; font-size:10px; color:#1B4F72; line-height:-.2;">$respuestaFac[lugarentr_solicitud] </p>
            <p style="text-align:center; font-size:10px; color:#1B4F72; line-height:.5;">$respuestaFac[direccion_lentrega]</p>
            <p style="text-align:center; font-size:10px; color:#1B4F72; line-height:-.2;"> $respuestaFac[cp_lentrega]</p>
            <p style="text-align:center; font-size:10px; color:#1B4F72;"> Solicitante:  $respuestaFac[solicitante_lentrega]</p>
            <p style="text-align:center; font-size:10px; color:#1B4F72; line-height:-.2;"> Email:  $respuestaFac[email_solicitante]</p>
